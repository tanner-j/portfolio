    ...
    return (
        <div className="bg-warmgray-100 h-auto xl:grid xl:grid-flow-col gap-16 md:p-24 p-20">
            ...
            <div className="xl:col-span-1 xl:pt-20 pt-12">
                <p className="text-lg lg:text-xl xl:text-2xl font-sarabun font-normal"><b>&#128075; Hi there, I'm Tanner.</b> I'm an aspiring web developer based out of Denver, CO. With a passion in front-end development, I love to design and code beautiful, intuitive user experiences from scratch.<br /><br />
