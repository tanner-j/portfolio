            ...
            <div className="bg-white h-auto items-center md:p-24 p-20">
                ...
                <Fade bottom cascade>
                    <div className="xl:grid xl:grid-flow-col xl:grid-cols-3 gap-10 pt-8 xl:space-y-0 space-y-10">
                        ...
                        <div className="xl:col-span-1 w-full bg-truegray-100 rounded-lg p-8 border-truegray-200 border border-opacity-40 shadow-lg">
                            <div className="flex items-center pb-4">
                        ...
                        <div className="xl:col-span-1 bg-truegray-100 rounded-lg p-8 border-truegray-200 border border-opacity-40 shadow-lg xl:relative">
